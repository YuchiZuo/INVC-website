  ...
  <div style="margin-left: 2px">
    ...
    <el-card style="flex: 1;min-height:400px;margin: 0 1px">
      ...
      <el-table :data="recruitPageTable.tableData" >
        ...
        <el-table-column label="操作" align="center">
          ...
          <template v-slot="scope">
            ...
            <el-button v-if="scope.row.state==='已结束'" disabled="" type="primary" plain @click="joinDialogOpen(scope.row) " class="el-button--mini">报名</el-button>
            <el-button v-else type="primary" plain @click="joinDialogOpen(scope.row) " class="el-button--mini">报名</el-button>
          </template>
      ...
      <el-pagination
          ...
          @current-change=" pagNum=>handleCurrentChange(pagNum,recruitPageTable)"
          :current-page="this.recruitPageTable.pageNum"
          :page-sizes="[100,200,300,400]"
          :page-size="this.recruitPageTable.pageSize"
          background
      ...
      <div style="display: flex;align-items: center;justify-content: center;margin-top: 30px">
        ...
        <el-button type="primary" plain @click="dialogOpen(recruitDialog)" style="margin-left: 40px">发布招募信息</el-button>
    ...
    <el-card style="flex: 1;margin: 0 1px">
      ...
      <el-pagination
          style="margin-top: 30px"
          @current-change=" pagNum=>handleCurrentChange(pagNum,briefPageTable)"
          :current-page="this.briefPageTable.pageNum"
          :page-sizes="[100,200,300,400]"
          :page-size="this.briefPageTable.pageSize"
          background
          layout="prev, pager, next"
      ...
      <div style="display: flex;align-items: center;justify-content: center;margin-top: 30px">
        ...
        <el-button type="primary" plain @click="dialogOpen(personBriefDialog)" style="margin-left: 40px">发布简历信息</el-button>
    ...
    <div  style="display: flex;justify-content: center;margin-top: 2px">
      <el-card style="flex: 1;min-height:600px;margin: 0 1px">
        <div>
          ...
          <el-pagination
              style="margin-top: 30px"
              @current-change="pagNum=>handleCurrentChange(pagNum,seatPageTable)"
              :current-page="this.seatPageTable.pageNum"
              :page-sizes="[100,200,300,400]"
              :page-size="this.seatPageTable.pageSize"
              background
              layout="prev, pager, next"
            ...
            <div v-for="item2 in 2" >
              <div style="display: flex">
                <div v-for="item3 in 3" >
                  ...
                  <!--              有人做的话显示蓝色和姓名，否则显示绿色-->
                  <div v-if="seat[(item1-1)*6+(item2-1)*3+item3-1].name" style="width: 120px;height: 36px;background-color: #5ca7ff;border-radius: 5px;border:1px solid #ffffff">
                    <!--                显示座位号和名字-->
                  ...
                  <div v-else   style="width: 120px;height: 36px;background-color: #79de64;border-radius: 5px;border:1px solid #ffffff">
                    <!--                显示座位号和名字-->
                    <div style="font-size: 12px">{{seat[(item1-1)*6+(item2-1)*3+item3-1].seatnum}}</div>
                    <div style="font-size: 15px;display: flex;align-items: center;justify-content: center">
                      {{seat[(item1-1)*6+(item2-1)*3+item3-1].name}}
    ...
    <el-dialog title="发布招募信息" :visible="recruitDialog.dialogInfoDialogVis" @update:visible="value => recruitDialog.dialogInfoDialogVis = value" width="60%">
    ...
    <el-dialog title="发布简历信息" :visible="personBriefDialog.dialogInfoDialogVis" @update:visible="value => personBriefDialog.dialogInfoDialogVis = value" width="60%">
    ...
    <el-dialog title="编辑招募信息" :visible="recruitEditDialog.dialogInfoDialogVis" @update:visible="value => recruitEditDialog.dialogInfoDialogVis = value" width="60%">
    ...
    <el-dialog title="报名" :visible="joinDialog.dialogInfoDialogVis" @update:visible="value => joinDialog.dialogInfoDialogVis = value" width="60%">
    ...
    <el-dialog title="我的报名" :visible="myJoinDialog.dialogInfoDialogVis" @update:visible="value => myJoinDialog.dialogInfoDialogVis = value" width="60%">
      ...
      <el-pagination
          ...
          :current-page="this.myJoinPage.pageNum"
          :page-sizes="[100,200,300,400]"
          :page-size="this.myJoinPage.pageSize"
          background
          layout="prev, pager, next"
          :total="this.myJoinPage.total">
      </el-pagination>
    ...
    <el-dialog title="我的招募" :visible="myRecruitDialog.dialogInfoDialogVis" @update:visible="value => myRecruitDialog.dialogInfoDialogVis = value" width="60%">
      ...
      <el-pagination
          ...
          :current-page="this.myRecruitPage.pageNum"
          :page-sizes="[100,200,300,400]"
          :page-size="this.myRecruitPage.pageSize"
          background
          layout="prev, pager, next"
    ...
    <el-dialog title="报名详情"  :visible.sync="reasonDialog.dialogInfoDialogVis" @update:visible="value => reasonDialog.dialogInfoDialogVis = value" width="30%">
    ...
    <el-dialog title="报名情况"  :visible.sync="applyConditionDialog.dialogInfoDialogVis" @update:visible="value => applyConditionDialog.dialogInfoDialogVis = value" width="60%">
      ...
      <el-pagination
          ...
          :current-page="this.applyConditionPage.pageNum"
          :page-sizes="[100,200,300,400]"
          :page-size="this.applyConditionPage.pageSize"
          background
          layout="prev, pager, next"
    ...
    <el-dialog title="招募详情" :visible="DetailDialog.dialogInfoDialogVis" @update:visible="value => DetailDialog.dialogInfoDialogVis = value" width="30%">
    ...
    <el-dialog title="简介详情" :visible="briefDetailDialog.dialogInfoDialogVis" @update:visible="value => briefDetailDialog.dialogInfoDialogVis = value" width="30%">
...
export default {
  ...
  methods:{
    ...
    handleCurrentChange(pageNum,pageTable,params={}){
      ...
      else pageTable.load(pageNum,params)
    },
    getAllSeat(){
